...
public class ChromosomeMaterial implements Comparable, Serializable {
    ...
    public String toString() {
        ...
        // -------------------------------------------------------
        Iterator<Allele> iter = m_alleles.iterator();
        if (iter.hasNext()) {
    ...
    public int compareTo(Object other) {
        ...
        SortedSet<Allele> otherAlleles = otherChromosome.m_alleles;
        ...
        // ---------------------------------------------------------------
        Iterator<Allele> iter = m_alleles.iterator();
        Iterator<Allele> otherIter = otherAlleles.iterator();
        while (iter.hasNext() && otherIter.hasNext()) {
            Allele allele = iter.next();
            Allele otherAllele = otherIter.next();
     ...
     * greater than
     * <code>threshold</code>; also, removes excess alleles from
     * <code>alleles</code>
     *
     * @param alleles
    ...
    private List<Allele> extractExcessAlleles(Collection<Allele> alleles, long threshold) {
        ...
        alleles.removeAll(result);
        return result;
    }

    /**
     * Calculates compatibility distance between this and
     * <code>target</code> according to <a
     ...
     * @return distance between this object and
     * <code>target</code>
