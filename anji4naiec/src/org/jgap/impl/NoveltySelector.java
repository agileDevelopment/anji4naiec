 ...
 */
public abstract class NoveltySelector extends Selector {
    ...
    public List<Chromosome> select(Configuration config) {
        ...
        if (result.size() > numToSelect) {
            Collections.sort(result, new ChromosomeNoveltyComparator(true /* asc */, false /* speciated fitness */));
