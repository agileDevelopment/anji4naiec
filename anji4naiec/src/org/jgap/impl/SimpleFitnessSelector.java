 ...
 */
public class SimpleFitnessSelector extends FitnessSelector {
    ...
    protected List<Chromosome> select(Configuration a_activeConfiguration, int a_howManyToSelect) {
        Collections.sort(chromosomes, new ChromosomeFitnessComparator(false /* asc */, true /* speciated fitness*/));
