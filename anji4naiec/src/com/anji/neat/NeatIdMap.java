...
public class NeatIdMap {
    ...
    private static final Logger logger = Logger.getLogger(NeatIdMap.class.getName());
    /**
    ...
    public boolean store() throws IOException {
        if (neatIdMapFileName != null) {
            ...
            logger.severe("neatIdMapFileName == null");
        }
        return false;
    }
     ...
     * @param pri
     */
    public void log(Logger aLogger, Level pri) {
