...
public class NeuronType {
    ...
    private static Map<String, NeuronType> types = null;
    /**
     * input neuron
     */
    ...
    /**
     * link expression output (LEO) neuron
     */
    public final static NeuronType LEO = new NeuronType("leo");
     ...
     * @return
     * <code>NeuronType</code> enumerated type corresponding to
     * <code>name</code>
     */
    public static NeuronType valueOf(String name) {
        if (types == null) {
            types = new HashMap<String, NeuronType>();
            ...
            types.put(NeuronType.LEO.toString(), NeuronType.LEO);
        }
