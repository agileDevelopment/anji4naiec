...
public class ConnectionAllele extends Allele {
    ...
    public ConnectionAllele(ConnectionGene aConnectionGene) {
        this(aConnectionGene, DEFAULT_WEIGHT);
    }
    
    /**
     * @param aConnectionGene
     */
    public ConnectionAllele(ConnectionGene aConnectionGene, double aConnectionWeight) {
        super(aConnectionGene);
        connectionGene = aConnectionGene;
        weight = aConnectionWeight;
    }
    ...
    /**
     * @param target should be
     * <code>ConnectionAllele</code> with same gene
     * @return
     * <code>double</code> compatibility distance based on weight; always
     * positive
