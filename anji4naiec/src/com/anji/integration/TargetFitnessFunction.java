 ...
 */
public abstract class TargetFitnessFunction implements EvaluationFunction, Configurable {

    private static final Logger logger = Logger.getLogger(TargetFitnessFunction.class.getName());
    ...
    final public void evaluate(List genotypes) {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                logger.warning("transcriber error: " + e.getMessage());
